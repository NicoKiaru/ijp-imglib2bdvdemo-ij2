...
@Plugin(type = BdvPlaygroundActionCommand.class,
        //menuPath = "Plugins>BIOP>Demos>Demo - Big ABBA Logo (Slow)"
        menu = {
                @Menu(label = BdvPgMenus.L1),
                @Menu(label = BdvPgMenus.L2),
                @Menu(label = "Demos", weight = 10),
                @Menu(label = "Demo - Big ABBA Logo (Slow)")
        }
)
public class DemoBigABBALogoSlowCommand implements BdvPlaygroundActionCommand {
